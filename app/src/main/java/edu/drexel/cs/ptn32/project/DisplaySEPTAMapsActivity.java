...
public class DisplaySEPTAMapsActivity extends FragmentActivity implements GoogleMap.OnMarkerClickListener, GoogleMap.OnInfoWindowClickListener, SeekBar.OnSeekBarChangeListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_septamaps);

        SupportMapFragment mapFragment =
                (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.mapSEPTA);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        final View mapView = getSupportFragmentManager().findFragmentById(R.id.mapSEPTA).getView();
            ...
            mapView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    for (String coordinates : listCoordinates) {
                        ...
                        String title = c[2];
                        String snippet = c[3] + " " + c[4];

                        // create new coordinate
                        LatLng latlng = new LatLng(lat, lon);

                        // Add markers to the map.
                        addMarkersToMap(latlng, title, snippet);
...
//                        count++;
    ...
    public void mapsSEPTAGoBack(View view) {
        this.finish();
    }
}