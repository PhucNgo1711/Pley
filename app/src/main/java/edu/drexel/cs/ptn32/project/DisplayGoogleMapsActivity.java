...
public class DisplayGoogleMapsActivity extends FragmentActivity implements GoogleMap.OnMarkerClickListener, GoogleMap.OnInfoWindowClickListener, SeekBar.OnSeekBarChangeListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (listCoordinates.size() > 1) {
            Button mapsStreetView = (Button)findViewById(R.id.mapsStreetView);
            mapsStreetView.setEnabled(false);
            mapsStreetView.setVisibility(View.INVISIBLE);
        }
    }
    ...
    public void mapsOpenStreetView(View view) {
        Intent intent = new Intent(this, DisplayStreetViewActivity.class);
        intent.putExtra("coordinate", listCoordinates);
        this.startActivity(intent);
    }

    public void mapsGoBack(View view) {
        this.finish();
    }
}
